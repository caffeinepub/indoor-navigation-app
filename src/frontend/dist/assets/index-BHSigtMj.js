...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X2, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = React$2.useState(null), [lt, J] = React$2.useState(null), [W, H] = React$2.useState(false), [A, mt] = React$2.useState(false), [L2, z2] = React$2.useState(false), [ct, d] = React$2.useState(false), [h, y] = React$2.useState(false), [R, j] = React$2.useState(0), [p, _] = React$2.useState(0), O = React$2.useRef(t.duration || X2 || Wt), G = React$2.useRef(null), k = React$2.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t.type, V = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = React$2.useMemo(() => S.findIndex((r) => r.toastId === t.id) || 0, [S, t.id]), Jt = React$2.useMemo(() => {
    var r;
    return (r = t.closeButton) != null ? r : et;
  }, [t.closeButton, et]), Tt = React$2.useMemo(() => t.duration || X2 || Wt, [t.duration, X2]), gt = React$2.useRef(0), U2 = React$2.useRef(0), St = React$2.useRef(0), K = React$2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React$2.useMemo(() => S.reduce((r, m, c) => c >= dt ? r : r + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
  ...
  function Zt() {
    var r, m, c;
    return P != null && P.loading ? React$2.createElement("div", { className: M(s == null ? void 0 : s.loader, (r = t == null ? void 0 : t.classNames) == null ? void 0 : r.loader, "sonner-loader"), "data-visible": N === "loading" }, P.loading) : rt ? React$2.createElement("div", { className: M(s == null ? void 0 : s.loader, (m = t == null ? void 0 : t.classNames) == null ? void 0 : m.loader, "sonner-loader"), "data-visible": N === "loading" }, rt) : React$2.createElement(Yt, { className: M(s == null ? void 0 : s.loader, (c = t == null ? void 0 : t.classNames) == null ? void 0 : c.loader), visible: N === "loading" });
  }
  return React$2.createElement("li", { tabIndex: 0, ref: k, className: M(ot, Kt, s == null ? void 0 : s.toast, (Dt = t == null ? void 0 : t.classNames) == null ? void 0 : Dt.toast, s == null ? void 0 : s.default, s == null ? void 0 : s[N], (Pt = t == null ? void 0 : t.classNames) == null ? void 0 : Pt[N]), "data-sonner-toast": "", "data-rich-colors": (Nt = t.richColors) != null ? Nt : F, "data-styled": !(t.jsx || t.unstyled || a), "data-mounted": W, "data-promise": !!t.promise, "data-swiped": h, "data-removed": A, "data-visible": Ut, "data-y-position": Gt, "data-x-position": Qt, "data-index": g, "data-front": Vt, "data-swiping": L2, "data-dismissible": V, "data-type": N, "data-invert": qt, "data-swipe-out": ct, "data-swipe-direction": lt, "data-expanded": !!(D || B && W), style: { "--index": g, "--toasts-before": g, "--z-index": i.length - g, "--offset": `${A ? R : U2.current}px`, "--initial-height": B ? "auto" : `${p}px`, ...ut, ...t.style }, onDragEnd: () => {
  ...
  }, className: M(s == null ? void 0 : s.cancelButton, (At = t == null ? void 0 : t.classNames) == null ? void 0 : At.cancelButton) }, t.cancel.label) : null, reactExports.isValidElement(t.action) ? t.action : t.action && tt(t.action) ? React$2.createElement("button", { "data-button": true, "data-action": true, style: t.actionButtonStyle || l, onClick: (r) => {
    var m, c;
...
const LocateFixed = createLucideIcon("locate-fixed", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
((qrcodegen2) => {
  const _QrCode = class _QrCode2 {
    ...
    getModule(x2, y) {
      return 0 <= x2 && x2 < this.size && 0 <= y && y < this.size && this.modules[y][x2];
    }
    ...
    drawAlignmentPattern(x2, y) {
      for (let dy = -2; dy <= 2; dy++) {
        for (let dx = -2; dx <= 2; dx++)
          this.setFunctionModule(x2 + dx, y + dy, Math.max(Math.abs(dx), Math.abs(dy)) != 1);
      }
    }
    // Sets the color of a module and marks it as a function module.
    // Only used by the constructor. Coordinates must be in bounds.
    setFunctionModule(x2, y, isDark) {
      this.modules[y][x2] = isDark;
      this.isFunction[y][x2] = true;
    }
      ...
      for (let right = this.size - 1; right >= 1; right -= 2) {
        ...
        for (let vert = 0; vert < this.size; vert++) {
          for (let j = 0; j < 2; j++) {
            ...
            if (!this.isFunction[y][x2] && i < data.length * 8) {
              this.modules[y][x2] = getBit(data[i >>> 3], 7 - (i & 7));
              i++;
            }
          }
        }
        ...
        for (let x2 = 0; x2 < this.size; x2++) {
          ...
          switch (mask) {
            ...
            case 3:
              ...
              break;
            case 4:
              invert2 = (Math.floor(x2 / 3) + Math.floor(y / 2)) % 2 == 0;
              break;
            case 5:
              invert2 = x2 * y % 2 + x2 * y % 3 == 0;
              break;
            case 6:
              invert2 = (x2 * y % 2 + x2 * y % 3) % 2 == 0;
              break;
            case 7:
              invert2 = ((x2 + y) % 2 + x2 * y % 3) % 2 == 0;
              break;
          ...
          if (!this.isFunction[y][x2] && invert2)
    ...
    static reedSolomonComputeDivisor(degree) {
      ...
      for (let i = 0; i < degree; i++) {
        for (let j = 0; j < result.length; j++) {
          result[j] = _QrCode2.reedSolomonMultiply(result[j], root2);
    ...
    static reedSolomonMultiply(x2, y) {
      if (x2 >>> 8 != 0 || y >>> 8 != 0)
...
function generatePath(modules, margin = 0) {
  ...
  modules.forEach(function(row, y) {
    ...
    row.forEach(function(cell, x2) {
      if (!cell && start !== null) {
        ops.push(
          `M${start + margin} ${y + margin}h${x2 - start}v1H${start + margin}z`
        );
        start = null;
        return;
      }
      if (x2 === row.length - 1) {
        ...
        if (start === null) {
          ops.push(`M${x2 + margin},${y + margin} h1v1H${x2 + margin}z`);
        } else {
          ops.push(
            `M${start + margin},${y + margin} h${x2 + 1 - start}v1H${start + margin}z`
          );
        }
        return;
      }
...
function getImageSettings(cells, size, margin, imageSettings) {
  ...
  const x2 = imageSettings.x == null ? cells.length / 2 - w / 2 : imageSettings.x * scale;
  ...
  if (imageSettings.excavate) {
    ...
    let ceilW = Math.ceil(w + x2 - floorX);
    let ceilH = Math.ceil(h + y - floorY);
    excavation = { x: floorX, y: floorY, w: ceilW, h: ceilH };
  }
  const crossOrigin = imageSettings.crossOrigin;
  return { x: x2, y, h, w, excavation, opacity, crossOrigin };
}
...
var QRCodeCanvas = React$2.forwardRef(
  function QRCodeCanvas2(props, forwardedRef) {
    ...
    const _b2 = extraProps, { style: style2 } = _b2, otherProps = __objRest(_b2, ["style"]);
...
const APJ_BLOCK_COORDS = [
  [17.632619, 78.505749],
  [17.632428, 78.505756],
  [17.632463, 78.506518],
  [17.632648, 78.50651]
];
const SRK_BLOCK_COORDS = [
  [17.632429, 78.505735],
  [17.632422, 78.505479],
  [17.633253, 78.505449],
  [17.633263, 78.505709]
...
function haversine(a, b) {
  ...
  const x2 = Math.sin(dLat / 2) ** 2 + Math.cos(a[0] * Math.PI / 180) * Math.cos(b[0] * Math.PI / 180) * Math.sin(dLon / 2) ** 2;
  return R * 2 * Math.asin(Math.sqrt(x2));
}
...
function isPointInCampusRect(pt) {
  ...
  return pt[0] >= minLat && pt[0] <= maxLat && pt[1] >= minLon && pt[1] <= maxLon;
}
...
function nearestEdgePoint(pt) {
  let best = {
    point: CAMPUS_ROUTE_NODES[0],
    edgeA: 0,
    edgeB: 1,
    t: 0,
...
function bearingDeg(from, to) {
  ...
  return (Math.atan2(y, x2) * 180 / Math.PI + 360) % 360;
}
async function fetchOsrmRoute(start, dest) {
  try {
...
async function fetchMapboxRoute(start, dest) {
  try {
...
function buildBackboneRoute(startPt, destPt) {
  const snapStart = nearestEdgePoint(startPt);
  const snapDest = nearestEdgePoint(destPt);
  const VIRTUAL_START = CAMPUS_ROUTE_NODES.length;
  const VIRTUAL_DEST = CAMPUS_ROUTE_NODES.length + 1;
...
function createArrowDivIcon(heading) {
  return L.divIcon({
    className: "",
...
function createCustomStartIcon(bearing) {
  return L.divIcon({
    className: "",
    html: `
...
async function searchPlaces(query) {
  ...
  if (MREM_PLACE.name.toLowerCase().includes(q) || MREM_PLACE.aliases.some((a) => a.toLowerCase().includes(q))) {
    results.push({
  ...
  for (const place of CAMPUS_PLACES) {
    const match = place.name.toLowerCase().includes(q) || place.aliases.some((a) => a.toLowerCase().includes(q));
    if (match) {
      results.push({
  ...
  try {
    ...
    for (const item of data) {
      ...
      if (results.find(
        (r) => r.lat === Number.parseFloat(item.lat) && r.lon === Number.parseFloat(item.lon)
      ))
        continue;
      const entry = {
        name,
...
function App() {
  ...
  const routeLayerRef = reactExports.useRef(null);
  const gpsMarkerRef = reactExports.useRef(null);
  const watchIdRef = reactExports.useRef(null);
  const prevGpsRef = reactExports.useRef(null);
  const currentGpsRef = reactExports.useRef(null);
  const tileLayerRef = reactExports.useRef(null);
  const apjLabelRef = reactExports.useRef(null);
  const srkLabelRef = reactExports.useRef(null);
  const customStartMarkerRef = reactExports.useRef(null);
  const [startInput, setStartInput] = reactExports.useState("");
  const [destInput, setDestInput] = reactExports.useState("");
  const [startCoords, setStartCoords] = reactExports.useState(null);
  const [destCoords, setDestCoords] = reactExports.useState(null);
  const [startSuggestions, setStartSuggestions] = reactExports.useState([]);
  const [destSuggestions, setDestSuggestions] = reactExports.useState([]);
  const [showStartSugg, setShowStartSugg] = reactExports.useState(false);
  const [showDestSugg, setShowDestSugg] = reactExports.useState(false);
  ...
  const [startPreview, setStartPreview] = reactExports.useState(null);
  const [destPreview, setDestPreview] = reactExports.useState(null);
  const [mapMode, setMapMode] = reactExports.useState("satellite");
  const [customStartCoords, setCustomStartCoords] = reactExports.useState(
    null
  );
  ...
  reactExports.useEffect(() => {
    ...
    map.on("mousedown", (e) => triggerLP(e.latlng));
  ...
  reactExports.useEffect(() => {
    const handler = (e) => {
      ...
      const bearing = destCoords ? bearingDeg([lat, lon], [destCoords.lat, destCoords.lon]) : 0;
      if (mapRef.current) {
  ...
  reactExports.useEffect(() => {
    ...
    const watchId = navigator.geolocation.watchPosition(
      ...
      { enableHighAccuracy: true, maximumAge: 1e3 }
    );
    watchIdRef.current = watchId;
    return () => navigator.geolocation.clearWatch(watchId);
  }, []);
  const startDebounceRef = reactExports.useRef(null);
  const destDebounceRef = reactExports.useRef(null);
  const clearCustomStart = reactExports.useCallback(() => {
    if (customStartMarkerRef.current && mapRef.current) {
      mapRef.current.removeLayer(customStartMarkerRef.current);
      customStartMarkerRef.current = null;
    }
  ...
  const handleStartInput = reactExports.useCallback(
    (val) => {
      setStartInput(val);
      setStartCoords(null);
  ...
  const handleDestInput = reactExports.useCallback((val) => {
    setDestInput(val);
    setDestCoords(null);
  ...
  const handleStartNavigate = reactExports.useCallback(async () => {
    if (!destInput.trim() && !destCoords) {
      ue.error("Please enter a destination");
      return;
    }
    setIsLoading(true);
    setRouteInfo(null);
    let resolvedStart = customStartCoords ?? startCoords ?? null;
    let startName = customStartCoords ? "Custom Location" : startInput.trim() || "My Location";
    if (!resolvedStart) {
      if (startInput.trim()) {
        const results = await searchPlaces(startInput);
        if (results.length === 0) {
          ue.error("Start location not found");
          setIsLoading(false);
          return;
        }
    ...
    if (!resolvedDest) {
      ...
      if (results.length === 0) {
        ue.error("Destination not found");
        setIsLoading(false);
        return;
      }
    ...
    const startPt = [resolvedStart.lat, resolvedStart.lon];
    const destPt = [resolvedDest.lat, resolvedDest.lon];
    ...
    if (routeCoords) {
      ...
      const timeMin = Math.ceil(distM / 83.3);
  ...
  const handleMyLocation = reactExports.useCallback(() => {
    if (currentGpsRef.current && mapRef.current) {
      ...
      navigator.geolocation.getCurrentPosition(
        (pos) => {
          var _a2;
          return (_a2 = mapRef.current) == null ? void 0 : _a2.flyTo(
  ...
  const handleZoomIn = reactExports.useCallback(() => {
    ...
    if (mapRef.current.getZoom() >= MAX_ZOOM)
      ue.info(`Maximum zoom reached (level ${MAX_ZOOM})`);
    else mapRef.current.zoomIn();
  }, []);
  const handleZoomOut = reactExports.useCallback(() => {
    var _a2;
    (_a2 = mapRef.current) == null ? void 0 : _a2.zoomOut();
  }, []);
  const truncate = (s, n = 22) => s.length > n ? `${s.slice(0, n)}…` : s;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-screen h-screen overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: mapContainerRef, className: "map-container" }),
    customStartCoords && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "absolute",
        ...
        children: "Custom start set – enter destination to route"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          panelCollapsed ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, style: { color: "#1E73BE", flexShrink: 0 } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.7)" }, children: truncate((startPreview == null ? void 0 : startPreview.name) || "Start") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.4)" }, children: "→" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14, style: { color: "#D84B4B", flexShrink: 0 } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.7)" }, children: truncate((destPreview == null ? void 0 : destPreview.name) || "Destination") }),
            ...
            "div",
            {
              ...
              children: [
                isNavigating && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 16 })
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-2", children: [
                    ...
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          ...
                          {
                            type: "text",
                            placeholder: customStartCoords ? "Custom location (long-pressed)" : "Current Location",
                            value: startInput,
                        ...
                        (startInput || customStartCoords) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
                            onMouseDown: () => {
                  ...
                  showStartSugg && startSuggestions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: startSuggestions.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          type: "button",
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#1E73BE", marginRight: "6px" }, children: "⊙" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        destInput && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
                            onMouseDown: () => {
                  ...
                  showDestSugg && destSuggestions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "absolute left-0 right-0 mt-1 rounded-xl overflow-hidden z-10",
                      style: {
                      ...
                      children: destSuggestions.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          type: "button",
                          className: "suggestion-item w-full text-left px-3 py-2 text-xs",
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#D84B4B", marginRight: "6px" }, children: "⊙" }),
                            s.name.length > 60 ? `${s.name.slice(0, 60)}…` : s.name
                          ]
                        },
                        `dest-${s.lat}-${s.lon}`
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Finding route\\u2026" })
          ...
          isNavigating && startPreview && destPreview && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        type: "button",
        onClick: () => setMapMode((prev) => prev === "satellite" ? "default" : "satellite"),
        style: {
          position: "absolute",
        ...
        children: mapMode === "satellite" ? "🗺 Map" : "🛰 Satellite"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(LocateFixed, { size: 20 })
      }
    ),
    routeInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "white", fontSize: "18px", fontWeight: 700 }, children: routeInfo.distanceM >= 1e3 ? `${(routeInfo.distanceM / 1e3).toFixed(1)} km` : `${Math.round(routeInfo.distanceM)} m` })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "white", fontSize: "18px", fontWeight: 700 }, children: routeInfo.timeMin < 60 ? `${routeInfo.timeMin} min` : `${Math.floor(routeInfo.timeMin / 60)}h ${routeInfo.timeMin % 60}m` })
              ]
            }
          )
        ]
    ...
    showQrModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "data-ocid": "qr.modal",
        role: "presentation",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "white", borderRadius: 12, padding: 12 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(QRCodeSVG, { value: window.location.href, size: 200 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
...
function PreviewCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", height: 80 }, children: [

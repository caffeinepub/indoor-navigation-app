...
function App() {
  ...
  const mremMarkerRef = reactExports.useRef(null);
  ...
  const handleStartInput = reactExports.useCallback((val) => {
    setStartInput(val);
    setStartCoords(null);
  ...
  const handleStartNavigate = reactExports.useCallback(async () => {
    ...
    try {
      ...
      if (!data.routes || data.routes.length === 0) {
        ue.error("No route found between these locations");
        setIsLoading(false);
        return;
      }
      ...
      ue.error("Failed to fetch route. Please try again.");
    }
    setIsLoading(false);
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        startInput && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
                            onMouseDown: () => {
